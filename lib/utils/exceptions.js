...
UnauthorizedError = function (message, title, returnUrl) {
    if(!(this instanceof UnauthorizedError)) throw new UnauthorizedError(message, title, returnUrl);
...
ForbiddenError = function (message, title, returnUrl) {
    if(!(this instanceof ForbiddenError)) throw new ForbiddenError(message, title, returnUrl);
...
NotFoundError = function (message, title, returnUrl) {
    if(!(this instanceof NotFoundError)) throw new NotFoundError(message, title, returnUrl);
...
ServerError = function (message, title, returnUrl) {
    if(!(this instanceof ServerError)) throw new ServerError(message, title, returnUrl);
...
NotImplementedError = function (message, title, returnUrl) {
    if(!(this instanceof NotImplementedError)) throw new NotImplementedError(message, title, returnUrl);
