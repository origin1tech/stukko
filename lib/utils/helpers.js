...
helpers = {
	...
	/**
	 * Compare two module versions checking for difference.
	 * @param {string} v1 - the primary version.
	 * @param {string} v2 - the comparison version.
...
//	},
    ...
    deleteKeys: function deleteKeys(object, keys) {
        var result;
