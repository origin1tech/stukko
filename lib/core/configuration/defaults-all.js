...
module.exports = function () {
	...
	return  {
		...
		middleware: {
            ...
            compression: { use: 'compression', enabled: undefined, options: {} },
            ...
            csrf: {	use: 'csurf', enabled: undefined },
            cors: {	use: 'cors', enabled: undefined },
            i18n: {	use: 'i18n', enabled: undefined	},
        ...
        //      colorize:               (default: undefined) - when NOT false default console transport uses color
        logs: {
            path: '/logs',
            level: 'info',
        ...
        bundler: {
            ...
            //      reload:                     (default: undefined) used for browser sync to enable.
            //      reloadDelay:                (default: 2000)  the reload delay for browser sync.
            //                                                  result in an error when using livereload.
            //      nowait:                     (default:undefined) when NOT false Stukko will boot w/o waiting for bundler bundles.
          ...
          // bundles are groups of files that our processed for concatenation,
            ...
            //      once:                   when true will only run bundle on initial load and not on watches.
