...
module.exports = function () {
	...
	return  {
        ...
        assets: {
            ...
            // ALL bundles EXCEPT "copy" & "html" require an "as" output name.
            // PROPERTIES:
            //      strategy:               (default: undefined) concat, copy, and browserify.
            ...
            //                                                   minify: minifies css, js. less and sass.
            //                                                   html: runs html minification compressor.
            //                                                   browserify: client side require utility.
            //                                                   sass: processes scss files for output to css.
            //                                                   less: processes less files for output to css.
