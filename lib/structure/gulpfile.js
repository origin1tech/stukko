...
function watcher() {
	...
	watch({ name: 'preprocess', glob: ['./web/assets/preprocess/**/*.less', './web/assets/preprocess/**/*.sass'] }, preprocess);
...
gulp.task('preprocess', ['clean'], preprocess);
gulp.task('framework', ['clean'], framework);
