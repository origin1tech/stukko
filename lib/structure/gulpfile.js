...
gulp.task('bundle', ['clean'], function () {
    ...
    keys.forEach(function(k) {
        ...
        if(bundle.strategy === 'systemjs') {
            ...
            // 'Plugin not installed, run "npm install systemjs-builder" from prompt.');
            //
            ...
            //                //    .then(function() {
            //                //        builder.loader.baseURL = 'assets/framework';
            //                //        builder.build('app')
            //                //            .then(function (output) {
            //                //                var file = new Buffer(output.source);
            //                //                self.push(file);
            //                //            });
            //                //    });
            //
            ...
            if(globs){
               var watcher = gulp.watch(
                ...
                watcher.on('change', function (changed) {
                    ...
                    }, assets.livereloadTimeout || assets.livereloadInterval || 300);
                });
...
gulp.task('test', function (cb) {
    ...
    builder.loader.baseURL = './assets/framework';
    builder.build('app', { sourceMaps: true }).then(function (output) {
        console.log(output);
        cb();
    })
    .catch(function(ex) {
